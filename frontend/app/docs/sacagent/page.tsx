...
export default function SACAgentPage() {
  return (
    <DocLayout>
      <div className="max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4">Conformal Coverage</h3>
          <p className="mb-6">
            Conformal Q-Learning provides a theoretical guarantee on the coverage of its prediction intervals. With high
            probability, the true Q-values lie within the constructed intervals, ensuring reliable uncertainty
            quantification.
          </p>

          <h3 className="text-xl font-semibold mt-8 mb-4">Group-Conditional Coverage</h3>
          <p className="mb-6">
            The algorithm extends to group-conditional coverage, allowing for more fine-grained uncertainty estimates
            across different subsets of the state-action space.
          </p>

          <h3 className="text-xl font-semibold mt-8 mb-4">Comparison with CQL</h3>
          <p className="mb-6">
            Theoretical analysis shows that Conformal Q-Learning is more optimistic than Conservative Q-Learning (CQL)
            while still maintaining conservative bounds, potentially leading to improved performance in practice.
          </p>
          ...
          <ul className="list-disc list-inside mb-6">
            <li>Improves policy stability and reduces uncertainty over training</li>
            <li>Enhances robustness against out-of-distribution (OOD) actions</li>
            <li>Achieves comparable or better performance than baseline methods like DQN and CQL</li>
          </ul>
